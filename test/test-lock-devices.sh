...
new "Commit 1"
expectpart "$($clixon_cli -1 -f $CFG -E $CFD -m configure commit 2>&1)" 0 "Device openconfig1 in state PUSH_LOCK:protocol lock-denied Operation failed, lock is already held" --not-- "OK"
