...
# B1: Disconnect all with NAME2 disabled -> silent (NAME2 already closed)
new "B1: Disconnect all (NAME2 disabled) -> CLI silent"
...
# B2: Disconnect all with NAME2 already CLOSED -> silent
new "B2: Disconnect all (NAME2 enabled+unreachable+closed) -> CLI silent"
expectpart "$($clixon_cli -1 -f $CFG -E $CFD connection close '*' 2>&1)" 0 "^$"
