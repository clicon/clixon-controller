...
/*! XXX For development only remove when confirmed */
#define DEVICE_DIFF1 // controller_reset
#define DEVICE_DIFF2 // rpc_get_device_config
#define DEVICE_DIFF3 // strip_service_data_from_device_config
#define DEVICE_DIFF4 // devices_match
#define DEVICE_DIFF5 // datastore_diff_dsref
#define DEVICE_DIFF6 // rpc_connection_change
#define DEVICE_DIFF7 // datastore_diff_device
#define DEVICE_DIFF8 // rpc_controller_commit / devices_diff
#define DEVICE_DIFF10 // controller_reset
#define DEVICE_DIFF11 // rpc_get_device_config / device_config_read
#define DEVICE_DIFF12 // device_config_compare
