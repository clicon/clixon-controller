...
/*! Keep device rpc reply data structures as state and GC it in periodic timer
 *
 * Backward-compatible option for 1.7 behavior
 * See backward-compatible check in test-restconf.sh
 */
#define CONTROLLER_DEVICE_RPC_REPLY_IN_STATE
